...
- The 2026 rates and thresholds sit in the **2026 tax parameters** panel and can all be
  edited.
- The colour theme follows your system setting and remembers it if you switch.
- This is a planning aid, not tax advice. It leaves out Box 3, the 30% ruling, pension
  build-up, prior-year retained earnings, partner/income-splitting and the
  gebruikelijkloon test — check anything that matters with a Dutch accountant.
